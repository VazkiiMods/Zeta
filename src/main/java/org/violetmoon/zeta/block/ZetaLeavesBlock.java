...
public class ZetaLeavesBlock extends LeavesBlock implements IZetaBlock {
    ...
    public ZetaLeavesBlock(String name, @Nullable ZetaModule module, MapColor color) {
        ...
        zeta.registry.registerBlock(this, name + "_leaves", true);
        zeta.renderLayerRegistry.put(this, RenderLayerRegistry.Layer.CUTOUT_MIPPED);
        zeta.creativeTabs.addToCreativeTabNextTo(CreativeModeTabs.NATURAL_BLOCKS, this, Blocks.BROWN_MUSHROOM_BLOCK, true);
    }
