...
public class FabricZPlayerInteract implements ZPlayerInteract {
    private final PlayerInteractEvent e;

    public FabricZPlayerInteract(PlayerInteractEvent e) {
        this.e = e;
    }
    ...
    public static class EntityInteractSpecific extends FabricZPlayerInteract implements ZPlayerInteract.EntityInteractSpecific {
    ...
    public static class EntityInteract extends FabricZPlayerInteract implements ZPlayerInteract.EntityInteract {
    ...
    public static class RightClickBlock extends FabricZPlayerInteract implements ZPlayerInteract.RightClickBlock {
    ...
    public static class RightClickItem extends FabricZPlayerInteract implements ZPlayerInteract.RightClickItem {
