...
public class FabricZMobSpawnEvent implements ZMobSpawnEvent {
    private final MobSpawnEvent e;

    public FabricZMobSpawnEvent(MobSpawnEvent e) {
        this.e = e;
    }
    ...
    public static class FinalizeSpawn extends FabricZMobSpawnEvent implements CheckSpawn {
