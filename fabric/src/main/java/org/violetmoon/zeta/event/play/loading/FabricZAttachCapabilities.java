...
public abstract class FabricZAttachCapabilities<T> implements ZAttachCapabilities<T> {
    protected final ZetaCapabilityManager zetaCaps;
    protected final AttachCapabilitiesEvent<T> e;

    public FabricZAttachCapabilities(ZetaCapabilityManager zetaCaps, AttachCapabilitiesEvent<T> e) {
    ...
    public static class ItemStackCaps extends FabricZAttachCapabilities<ItemStack> implements ZAttachCapabilities.ItemStackCaps {
        public ItemStackCaps(ZetaCapabilityManager zetaCaps, AttachCapabilitiesEvent<ItemStack> e) {
            super(zetaCaps, e);
        }
    }

    public static class BlockEntityCaps extends FabricZAttachCapabilities<BlockEntity> implements ZAttachCapabilities.BlockEntityCaps {
        public BlockEntityCaps(ZetaCapabilityManager zetaCaps, AttachCapabilitiesEvent<BlockEntity> e) {
            super(zetaCaps, e);
        }
    }

    public static class LevelCaps extends FabricZAttachCapabilities<Level> implements ZAttachCapabilities.LevelCaps {
