...
public class FabricZRightClickBlock implements ZRightClickBlock {
	private final PlayerInteractEvent.RightClickBlock e;

	public FabricZRightClickBlock(PlayerInteractEvent.RightClickBlock e) {
		this.e = e;
	}
	...
	public ZResult getUseBlock() {
		return FabricZeta.from(e.getUseBlock());
	}
	...
	public static class Low extends FabricZRightClickBlock implements ZRightClickBlock.Low {
